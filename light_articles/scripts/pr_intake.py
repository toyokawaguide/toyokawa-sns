...
def send_preview(row: dict, title: str, body: str, img: Path, *, dry: bool,
    ...
    text = "\n".join([
        ...
        *photo_notice,
        ...
        "※掲載は自動配信のため、掲載日・時刻が多少前後する場合があります。あらかじめご了承ください。",
        "※「OK」のご返信は、社内・関係者の確認を済ませたうえでお願いします。",
        "",
        "■ 直したいところがある場合",
        ...
        "写真は合計5枚までお送りいただけます（1枚だけでも大丈夫です）。",
        "",
        "■ 公開後の取り下げについて",
        "公開後の記事・SNS投稿の取り下げは、すぐに対応できない場合があります。",
        "SNSに投稿した内容は削除前に閲覧・拡散されている可能性があり、完全には消せません。",
        "写真や内容に少しでも不安がある場合は、公開前にこのメールへご返信ください。",
        "",
        "※この時点ではまだ公開されていません。ご確認いただいてから公開します。",
        "※管理人からのご連絡・作業は基本的に夜の時間帯です。ご返信が遅い時間や翌日以降になる場合がありますが、必ずお返事いたします。",
        "",
        SITE,
    ])

...
def read_all_rows(sheet: str = None, spreadsheet_id: str = None) -> list[dict]:
...
def update_status(row_index: int, new_status: str, sheet: str = None, spreadsheet_id: str = None):

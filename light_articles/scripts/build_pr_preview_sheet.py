...
rows = [
    ...
    ["", "", "", "", "", ""],                                                             # 1
    ["豊川ガイド ｜ さくっとPR", "", "", "", "", ""],                                      # 2 帯
    [f'=IF({IDX("U")}<>"",{IDX("U")},IFERROR(REGEXEXTRACT({IDX("N")},"ラベル：(.+)"),"PR"))'
     f'&"　／　色："&IF({IDX("V")}<>"",{IDX("V")},IFERROR(REGEXEXTRACT({IDX("N")},"色：([^（\\n]+)"),"おまかせ"))', "", "", "", "", ""],  # 3 ラベル・色（専用列U/V優先）
    [f'={IDX("E")}', "", "", "", "", ""],                                                 # 4 ひとこと（大）
    [f'={IDX("D")}', "", "", "", "", ""],                                                 # 5 店名
    [f'="● "&{IDX("G")}', "", "", "", "", ""],                                            # 6 住所
    ["", "", "", "", "", ""],                                                             # 7
    ...
    ["", "", "", "", "", ""],                                                             # 19
    [f'="📁 写真フォルダ名（マイドライブ＞さくっとPR の中に作る）： "&{IDX("A")}&"_"&{IDX("D")}', "", "", "", "", ""],  # 20

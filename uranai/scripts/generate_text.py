...
def _dummy_template_data_monday(spot: Spot) -> dict:
    ...
    return {
        "intro_text": "新しい1週間が始まりますね。新月期に差しかかる頃、新しいことを始めるのにぴったりかもしれません。",
        "items": [
            {"label": "おひつじ座", "stars": 8, "comment": "今日のあなたは行動力抜群。思いついたら即実行で吉。ただし周囲への気配りも忘れずに。"},
            {"label": "おうし座", "stars": 6, "comment": "のんびりペースでOKな日。無理に予定を詰め込まず、自分のリズムを大切に。"},
            {"label": "ふたご座", "stars": 10, "comment": f"コミュニケーション運絶好調！誰かと話すだけで気分が上がります。{spot.name} に立ち寄ってみては？"},
            {"label": "かに座", "stars": 4, "comment": "感情が揺れやすい日。深呼吸して、家族や身近な人との時間を大切に。"},
            {"label": "しし座", "stars": 10, "comment": "オーラ全開。今日のあなた、ちょっと無敵かも。やりたいことを思い切ってどうぞ。"},
            {"label": "おとめ座", "stars": 6, "comment": "細部に気を配ると吉。ただし完璧主義は控えめに。"},
            {"label": "てんびん座", "stars": 5, "comment": "バランス感覚が問われる日。判断は慎重に、急がず冷静に。"},
            {"label": "さそり座", "stars": 7, "comment": "直感が冴える日。気になることがあったら、迷わず動いてみて。"},
            {"label": "いて座", "stars": 8, "comment": "ノリと勢いの日。考えるより先に、動いちゃおう。新しい発見があるかも。"},
            {"label": "やぎ座", "stars": 6, "comment": "コツコツ続けていることに進展あり。焦らず一歩ずつ。"},
            {"label": "みずがめ座", "stars": 3, "comment": "新しいアイデアより、既存の整理が吉。デスクまわりを片付けてみて。"},
            {"label": "うお座", "stars": 5, "comment": "感性が豊かになる一日。音楽や映画、自然に触れると心が満たされます。"},
        ],
    }
...
def _dummy_template_data_wednesday(spot: Spot) -> dict:
    ...
    return {
        "intro_text": "週の真ん中、水曜日です。水星の支配日、思考や言葉の冴える頃かも。",
        "items": [
            {"label": "1月生まれ", "stars": 8, "comment": "落ち着いた行動が吉と出る日。じっくり考えてから動けば、しっかり成果に繋がります。"},
            {"label": "2月生まれ", "stars": 6, "comment": "穏やかな1日になりそう。深呼吸して、自分のペースを大切にしてみて。"},
            {"label": "3月生まれ", "stars": 10, "comment": f"絶好調の予感。前向きな気持ちが運気を呼びます。{spot.name} に立ち寄ってみては？"},
            {"label": "4月生まれ", "stars": 4, "comment": "ペースが乱れがちな日。無理せず、休憩をしっかり取って心を整えましょう。"},
            {"label": "5月生まれ", "stars": 10, "comment": "創造力が冴える日。気になるアイデアは即メモしておいて。"},
            {"label": "6月生まれ", "stars": 6, "comment": "コミュニケーションが穏やかに進む日。相手の話に耳を傾けると吉。"},
            {"label": "7月生まれ", "stars": 5, "comment": "ぼちぼち進めばOK。完璧を求めすぎず、ほどほどに。"},
            {"label": "8月生まれ", "stars": 7, "comment": "新しい風が吹きそうな日。ちょっとした変化を楽しんでみて。"},
            {"label": "9月生まれ", "stars": 8, "comment": "段取り上手な日。今日中にやることリストを片付けてしまうのが吉。"},
            {"label": "10月生まれ", "stars": 6, "comment": "バランス感覚が冴える日。判断は急がず、慎重に。"},
            {"label": "11月生まれ", "stars": 3, "comment": "感情が揺れやすい日。深呼吸して、ゆっくり過ごしましょう。"},
            {"label": "12月生まれ", "stars": 5, "comment": "コツコツ続けていることに進展あり。焦らず一歩ずつ。"},
        ],
    }
...
def _dummy_template_data_thursday(spot: Spot) -> dict:
    ...
    return {
        "intro_text": "今日は木曜、木星の支配日。自分の干支、覚えてますか？大きな視点で動くといい頃かも。",
        "items": [
            {"label": "子（ねずみ）年", "stars": 8, "comment": "機転が利く日。気付いたら即行動が吉と出ます。"},
            {"label": "丑（うし）年", "stars": 6, "comment": "コツコツ続けてきたことに手応えあり。じっくり地に足つけて。"},
            {"label": "寅（とら）年", "stars": 10, "comment": f"勢いに乗れる日。やりたいことに迷わずGO。{spot.name} にぶらっと足を運んでみて。"},
            {"label": "卯（うさぎ）年", "stars": 4, "comment": "ペースが乱れがち。深呼吸して、自分のリズムを取り戻しましょう。"},
            {"label": "辰（たつ）年", "stars": 10, "comment": "オーラ全開。何をやってもうまくいきそうな1日です。"},
            {"label": "巳（へび）年", "stars": 6, "comment": "直感が冴える日。気になったことは、迷わず確かめてみて。"},
            {"label": "午（うま）年", "stars": 5, "comment": "バランス感覚が問われる日。急がず、冷静に判断を。"},
            {"label": "未（ひつじ）年", "stars": 7, "comment": "穏やかな運気。周りの人との会話から、いいヒントが得られそう。"},
            {"label": "申（さる）年", "stars": 8, "comment": "発想が豊かになる日。新しい角度から物事を見てみて。"},
            {"label": "酉（とり）年", "stars": 6, "comment": "細部に気を配ると吉。ただし完璧主義は控えめに。"},
            {"label": "戌（いぬ）年", "stars": 3, "comment": "情熱が空回りしがち。一旦休憩を取って、頭を冷やしましょう。"},
            {"label": "亥（いのしし）年", "stars": 5, "comment": "感情が動く日。家族や身近な人との時間を大切に。"},
        ],
    }
...
def _dummy_template_data_friday(spot: Spot) -> dict:
    ...
    return {
        "intro_text": "今日は金曜、金星の支配日。今日いいことが起こりそうな生まれ年のTOP10を発表します。あなたの生まれ年、入ってるかな？",
        "items": [
            {"label": "1990年（平成2年）生まれ", "comment": f"絶好調の予感。何やってもうまくいきそうな1日です。{spot.name} に立ち寄ってみては？"},
            {"label": "2003年（平成15年）生まれ", "comment": "笑顔が連鎖する日。挨拶ひとつで運気アップ。新しい出会いも期待できそう。"},
            {"label": "1976年（昭和51年）生まれ", "comment": "落ち着いた行動が吉。じっくり考えて動けば、しっかり成果に繋がります。"},
            {"label": "2020年（令和2年）生まれ", "comment": "周りから可愛がられる1日。素直な気持ちが運気を呼びます。"},
            {"label": "1984年（昭和59年）生まれ", "comment": "経験が活きる日。これまでの積み重ねが評価されそうな予感です。"},
            {"label": "1996年（平成8年）生まれ", "comment": "新しい風が吹く1日。直感を信じて動いてみるとラッキーが舞い込みます。"},
            {"label": "1965年（昭和40年）生まれ", "comment": "穏やかに過ごせる日。お気に入りの場所でゆっくりするのが吉。"},
            {"label": "1973年（昭和48年）生まれ", "comment": "段取り上手な日。計画的に動けば気持ちよく1日を終えられそう。"},
            {"label": "2008年（平成20年）生まれ", "comment": "好奇心が冴える日。気になることに思い切って挑戦してみて。"},
            {"label": "1959年（昭和34年）生まれ", "comment": "周りから頼られる1日。あなたの一言が誰かの背中を押すかも。"},
        ],
    }
...
def _dummy_template_data_saturday(spot: Spot) -> dict:
    ...
    return {
        "intro_text": "土曜、土星の支配日。154町の中から、今日いいことが起こりそうなTOP10を発表しちゃいます。あなたのお住まいの町、入ってるかな？",
        "items": [
            {"label": "門前町", "comment": f"門前町にお住まいのあなた、今日は絶好調の予感。{spot.name} にぶらっと足を運んでみて。"},
            {"label": "諏訪", "comment": "諏訪の皆さん、今日は穏やかな運気。ゆっくり過ごす1日が吉と出そうです。"},
            {"label": "国府町", "comment": "国府町にお住まいのあなた、新しい出会いに恵まれそう。笑顔を忘れずに。"},
            {"label": "牛久保町", "comment": "牛久保町の皆さん、コツコツ続けてきたことに進展あり。焦らず一歩ずつ。"},
            {"label": "桜ヶ丘町", "comment": "桜ヶ丘町にお住まいのあなた、創造力が冴える1日。アイデアをメモしておいて。"},
            {"label": "御油町", "comment": "御油町の皆さん、家族や身近な人との時間を大切に。心が満たされそう。"},
            {"label": "為当町", "comment": "為当町にお住まいのあなた、段取り上手な日。やることリストを片付けて。"},
            {"label": "三上町", "comment": "三上町の皆さん、直感が冴える日。気になったことは確かめてみて吉。"},
            {"label": "新道町", "comment": "新道町にお住まいのあなた、周りから頼られる1日。素直な気持ちで応えて。"},
            {"label": "千歳通", "comment": "千歳通の皆さん、ゆっくりペースでOK。自分のリズムを大切にしましょう。"},
        ],
    }
...
def _dummy_template_data_tuesday(spot: Spot) -> dict:
    ...
    return {
        "intro_text": "今日は火曜、火星の支配日。たった4種類なのに、なぜか当たる気がするやつ、いきましょう。",
        "blood": {
            "A": {
                "stars": 8,
                "comment": "段取り上手な日。今日中にやることリストを片付けてしまうと気持ちよく1日を終えられそう。",
                "match": "O型 - ペースを合わせてくれる頼れる相手",
                "action": "デスクまわりを片付ける",
                "caution": "完璧を求めすぎない",
            },
            "B": {
                "stars": 6,
                "comment": "マイペースが吉と出る日。自分のリズムを大切に、無理せずいきましょう。",
                "match": "AB型 - 違う角度から刺激をくれる存在",
                "action": "いつもと違うランチを選ぶ",
                "caution": "周りのペースに巻き込まれすぎない",
            },
            "O": {
                "stars": 10,
                "comment": f"絶好調の予感。社交運MAXで、今日は誰と話しても話が弾みそう。{spot.name} に立ち寄ってみては？",
                "match": "B型 - 一緒にいて笑顔が増える相手",
                "action": "会いたい人にLINEする",
                "caution": "良かれと思ってのお節介に注意",
            },
            "AB": {
                "stars": 7,
                "comment": "発想が冴える日。新しい角度から物事を見られそう。アイデアが浮かんだらメモしておいて。",
                "match": "A型 - 落ち着きをくれる頼れる相手",
                "action": "本屋やカフェで一人時間",
                "caution": "考えすぎて動けなくならないように",
            },
        },
    }
